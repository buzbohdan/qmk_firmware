 ...
 */
 ...
 [_QWERTY] = LAYOUT( \
  ...
  XXXXXXX,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,  KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_GRV, \
              KC_DOWN, LGUI_T(KC_UP), RSFT_T(KC_BSPC), LT(_LOWER, KC_DEL),    LT(_RAISE, KC_ENT), RSFT_T(KC_SPC), KC_LEFT, KC_RGHT \
),
/* LOWER `
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
...
[_LOWER] = LAYOUT( \
  ...
  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,                     KC_F7,  KC_UNDS, KC_LSFT,  KC_F10,  KC_F11,  KC_PAUS, \
...
[_RAISE] = LAYOUT( \
  ...
  KC_GRV,  KC_1,    KC_2,    KC_MS_U, KC_4,    KC_5,                        KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    _______, \
  KC_F1,  KC_F2,    KC_MS_L, KC_MS_D, KC_MS_R,   KC_F6,                       XXXXXXX, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, XXXXXXX, \
